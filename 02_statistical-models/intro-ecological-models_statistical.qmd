...
So the raw data suggest fish diversity observations are similar inside and outside of MPAs in New South Wales. But what if we adjust for biases due to other variables that might be influencing diversity at these locations? Let's run the statistical model now to see. 
